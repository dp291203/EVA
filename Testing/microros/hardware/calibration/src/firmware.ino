...
{
    if(Kinematics::LINO_BASE == Kinematics::MECANUM)
    {
        total_motors = 4;
    }
...
void printSummary()
{
    ...
    Kinematics::velocities max_linear = kinematics.getVelocities(max_rpm, 0, 0, max_rpm);
    Kinematics::velocities max_angular = kinematics.getVelocities(max_rpm, max_rpm,max_rpm, max_rpm);
    Serial.println(max_linear.linear_y);
    Serial.println(max_angular.angular_z);
