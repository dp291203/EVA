...
#define COUNTS_PER_REV1 4784              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 4784              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 4784              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 4784              // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.127                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.414            // distance between left and right wheels
...
// MOTOR PINS
  ...
  #define MOTOR1_PWM 3  //Pin no 21 is not a PWM pin on Teensy 4.x, you can use pin no 1 instead.
...
// jr's board pins
// #ifdef USE_GENERIC_1_IN_MOTOR_DRIVER
//   #define MOTOR2_PWM 2 //Pin no 21 is not a PWM pin on Teensy 4.x, you can use pin no 1 instead.
